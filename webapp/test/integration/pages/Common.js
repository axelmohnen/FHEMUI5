sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("fhemui5/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("fhemui5.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["fhemui5/localService/mockserver"], function (mockserver) {
